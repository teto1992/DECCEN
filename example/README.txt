...
This directory contains the TSV and related files of the moreno_lesmis network:
...
Files: 
    ...
    out.moreno_lesmis -- The adjacency matrix of the network in space separated values format, with one edge per line
...
@MISC{konect:2016:moreno_lesmis,
